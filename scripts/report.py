...
MAMA_QUOTES = {
    "freeze": [
        "早安，市民们！昨天的天台乐透开奖，结果是满员的绿油油！在这个连韭菜都懒得看盘的冰封期，股票和币圈讨论区凉得像医院的太平间。想抄底？先买好你的速效救心丸吧，市民们！",
        "电台频道里已经没人在提这个垃圾了。讨论菜价都比这大盘有生气。连救护车都懒得去清扫那些因爆仓而从写字楼天台跳下来的投机者尸体。",
        "公共频道里安静得像被拔了网线。上次在群里发持仓截图的倒霉蛋，他的账号已经被债主强行清算，正骑着电动车在风雨里送外卖。"
    ],
    "cold": [
        "哦，你居然还在坚守那堆废铜烂铁？连街边收废品的大爷都不屑于用它结算尾款。大家都去抢购特价大米和打折鸡蛋了。至于这大盘？那是什么，能当房租交吗？",
        "偶尔有些不怕死的韭菜在群里问一句‘还能接盘吗’，结果是被无情地踢出群聊。别做梦了，在这个市场里，没有人会同情你的电子钱包，它们比你的命还薄。"
    ],
    "neutral": [
        "大盘一切照旧。写字楼里的白领在加班猝死，外卖员在街头狂奔。这个标的正在温和的泥潭里打滚，没人在乎，保持你可怜的理智吧，市民们。",
        "不温不火的一天。本地新闻刚刚播报了三起电动车起火案，而我们的大盘指数和天台乐透一样平静。暂时死不了，但也别想翻身，祝你们好运吧。"
    ],
    "hot": [
        "早安！市民们！快看窗外，那些平时只买得起打折方便面的底层打工人，居然开始在早餐摊上兴致勃勃地讨论公司股票的K线了！傻子们正在兴奋地擦亮眼睛，准备跑步进场。我打赌，机构的高层现在嘴都笑歪了。",
        "广播里的理财广告已经铺天盖地。连足疗店的小妹都在向你兜售‘稳赚不赔的翻倍股票’。市民们开始疯狂抵押车子去加杠杆。听我一句劝：风暴要来了！"
    ],
    "lava": [
        "警告！警告！全城的贪婪值已经突破临界点！连你二姑、小区保安、甚至街角卖煎饼果子的大叔，都红着眼求你帮他开户！交易所顶楼正在放用散户骨灰做的烟花！如果你不想成为明天的天台名单，火速逃命吧，市民们！",
...
REVIEW_GOLDEN_QUOTES = [
    ...
    "Good luck out there, citizens. Keep your money close, and your emergency savings closer."
]
...
def generate_web_report(mci_data, config, quotes_json=None):
    ...
    for asset in mci_data.get("assets", []):
        ...
        if mci is None:
            ...
            if "518880" in sym_upper or "黄金" in asset.get("name", ""):
                if mci >= 81:
                    advice = "黄金暴涨！街头疯传金条比房产证还保值，市民们甚至连夜去金店排队抢购，狂热度彻底炸裂！强烈建议逢高分批抛售，把本金落袋为安，快逃！"
                elif mci >= 61:
                    advice = "金价新高让写字楼里的投机狗们蠢蠢欲动，午餐时间全在讨论是买实物金还是开通加倍杠杆。风暴将至，建议分批止盈，降低仓位。"
                elif mci >= 41:
                    advice = "避险金属在箱体正常调整，庄家和投机客都对它反应平平。"
                elif mci >= 21:
                    advice = "金价低位盘整，市民们嫌弃黄金没有垃圾题材股刺激，兴趣寥寥。逆向来看，这反而是绝佳的避险防御配置期。"
                else:
                ...
                if mci >= 81:
                    ...
                    advice = "白酒板块正常盘整，市民反应中性，无异常追加或割肉。建议暂时保持底仓，静观其变。"
                elif mci >= 21:
                ...
                if mci >= 81:
                    advice = "核心资产被炒到了天上，炒家和白领都在疯狂囤货，扬言它能涨到云端。泡沫明显，强烈建议逢高分批套现退场，市民们！"
                elif mci >= 61:
                ...
                if mci >= 81:
                    ...
                    advice = "市民们开始打听如何注册去中心化钱包，热度正在上升。空气里满是危险的本金炮灰味，建议提高警惕，保护利润，分批高抛。"
                elif mci >= 41:
    ...
    if p_mci is None:
        ...
        tomorrow_watch.append("市民退潮。指数进入深度超卖的恐慌底部，密切关注主力低吸企稳信号。")
